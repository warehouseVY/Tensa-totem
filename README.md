...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>3</td>
      <td><button onclick="window.location.href=('Fotos/A11.JPG', '_blank')">A11</button></td>
    </tr>
    <tr>
      <td>000000000030000051.1</td>
      <td>TOTEM BAG DROP</td>
      <td>6</td>
      <td><button onclick="window.location.href=('Fotos/A12.JPG', '_blank')">A12</button></td>
    </tr>
    <tr>
        <td>000000000030000051.10</td>
        <td>TOTEM TRASERAS CHECKIN</td>
        <td>1</td>
        <td><button onclick="window.location.href=('Fotos/A2.JPG', '_blank')">A2</button></td>
    </tr>
    <tr>
        <td>000000000030000051.11</td>
        <td>TOTEM SELF-CHECK-IN TRIANGULARES</td>
        <td>12</td>
        <td><button onclick="window.location.href=('Fotos/A3.JPG', '_blank')">A3</button></td>
    </tr>
    <tr>
        <td>000000000030000051.3</td>
        <td>TOTEM PREMIUM TIMEFLEX</td>
        <td>3</td>
      <td><button onclick="window.location.href=('Fotos/A13.JPG', '_blank')">A13</button></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>2</td>
       <td><button onclick="window.location.href=('Fotos/A1.JPG', '_blank')">A1</button></td>
    </tr>
    <tr>
        <td>30000166</td>
        <td>TOTEM EMBARQUE PREFERENTE</td>
        <td>5</td>
        <td><button onclick="window.location.href=('Fotos/A9.JPG', '_blank')">A9</button></td>
    </tr>
    <tr>
        <td>000000030000166.01</td>
        <td>TOTEM EMBARQUE PREFERENTE ITALIANO</td>
        <td>1</td>
        <td><button onclick="window.location.href=('Fotos/A6.JPG', '_blank')">A6</button></td>
    </tr>
    <tr>
        <td>VY0021</td>
        <td>TOTEM MADRID</td>
        <td>1</td>
       <td><button onclick="window.location.href=('Fotos/A5.JPG', '_blank')">A5</button></td>
    </tr>
    <tr>
        <td>VYCK 103</td>
    ...
    <tr>
        ...
        <td>1</td>
     <td><button onclick="window.location.href=('Fotos/A7.JPG', '_blank')">A7</button></td>
    </tr>
    <tr>
        <td>VYCK 122</td>
        <td>TOTEM FACIAL RECOGNITION</td>
        <td>1</td>
        <td><button onclick="window.location.href=('Fotos/A10.JPG', '_blank')">A10</button></td>
    </tr>
</tbody>
</table>
<h3>TENSABARRIERS</h3>
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>10</td>
<td><button onclick="window.location.href=('Fotos/B1.JPG', '_blank')">B1</button></td>
    </tr>
    <tr>
      <td>300000174</td>
      <td>PORTACARTELES TENSABARRIER DINA4</td>
      <td>1</td>
      <td><button onclick="window.location.href=('Fotos/B3.JPG', '_blank')">B3</button></td>
    </tr>
    <tr>
        <td>000000000030000076.2</td>
        <td>TENSABARRIERS AMARILLOS</td>
        <td>131</td<td><button onclick="window.location.href=('Fotos/B4.JPG', '_blank')">B4</button></td>
    </tr>
    <tr>
        <td>000000000030000076.3</td>
        <td>TENSABARRIERS AMARILLOS NUEVOS (USADOS)</td>
        <td>93</td>
        <td><button onclick="window.location.href=('Fotos/B5.JPG', '_blank')">B5</button></td>
    </tr>
    <tr>
        <td>VY202</td>
    ...
    <tr>
        ...
        <td>26</td>
        <td><button onclick="window.location.href=('Fotos/B6.JPG', '_blank')">B6</button></td>
    </tr>
    <tr>
        <td>VYTENSA22</td>
        <td>TENSABARRIERS RECICLADOS (PINTADOS)</td>
        <td>7</td>
      <td><button onclick="window.location.href=('Fotos/B7.JPG', '_blank')">B7</button></td>
    </tr>
</tbody>
</table>
</body>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>PORTACARTELES TENSABARRIER DINA3</td>
      <td>10</td>
      <td><button class="ver-foto-btn" src="B1.jpg" onclick="window.open('Fotos/B1.JPG', '_blank'))">B1</button></td>
    </tr>
    <tr>
      <td>300000174</td>
      <td>PORTACARTELES TENSABARRIER DINA4</td>
      <td>1</td>
      <td><button class="ver-foto-btn" src="B3.jpg" onclick="window.open('Fotos/B3.JPG', '_blank'))">B3</button></td>
    </tr>
    <tr>
        <td>000000000030000076.2</td>
        <td>TENSABARRIERS AMARILLOS</td>
        <td>131</td>
        <td><button class="ver-foto-btn" src="B4.jpg" onclick="window.open('Fotos/B4.JPG', '_blank'))">B4</button></td>
    </tr>
    <tr>
        <td>000000000030000076.3</td>
        <td>TENSABARRIERS AMARILLOS NUEVOS (USADOS)</td>
        <td>93</td>
        <td><button class="ver-foto-btn" src="B5.jpg" onclick="window.open('Fotos/B5.JPG', '_blank'))">B5</button></td>
    </tr>
    <tr>
        <td>VY202</td>
        <td>MATERIAL PARA DESTRUIR (TENSABARRIER Y MEDIDOR)</td>
    ...
    <tr>
        ...
        <td>TENSABARRIERPARA RECICLAR</td>
        <td>26</td>
        <td><button class="ver-foto-btn" src="B6.jpg" onclick="window.open('Fotos/B6.JPG', '_blank'))">B6</button></td>
    </tr>
    <tr>
        <td>VYTENSA22</td>
        <td>TENSABARRIERS RECICLADOS (PINTADOS)</td>
        <td>7</td>
        <td><button class="ver-foto-btn" src="B7.jpg" onclick="window.open('C:/Users/daniel.bagan/plataforma_referencia/Fotos/B7.JPG', '_blank'))">B7</button></td>
    </tr>
</tbody>
</table>
</body>
